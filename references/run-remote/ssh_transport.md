...
When no authenticated fingerprint exists, stop at the host-identity gate; the connection remains
unverified. Never delete the old key and blindly re-accept an unreviewed replacement.
